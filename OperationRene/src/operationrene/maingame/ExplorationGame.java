...
public class ExplorationGame extends GameplayState {
    ...
    private boolean visibleShape = false;
    ...
    public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException {
        ...
        if (visibleShape) {
            ...
            for (Rectangle r : map.getPulsatingAlarms().keySet()) {
                g.draw(r);
            }
        }
    ...
    public void update(GameContainer container, StateBasedGame game, int delta) throws SlickException {
        ...
        } else if (input.isKeyDown(Input.KEY_O) && input.isKeyDown(Input.KEY_R) && mapLevel == MapID.LEVEL_RANDOM){
        visibleShape = true;
        } else if(input.isKeyDown(Input.KEY_O) && input.isKeyDown(Input.KEY_Y) && mapLevel == MapID.LEVEL_RANDOM){
            visibleShape = false;
        }
